...
const HowWeInnovate = () => {
  return (
    <section className="px-6 sm:px-10 md:px-28 lg:px-48 py-10 md:py-20">
      <p className="font-helvetica-bold text-2xl sm:text-3xl md:text-5xl text-center md:text-left">
        How We Innovate
      </p>
      <div className="mt-8 md:mt-10 flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-12 text-gray-500 font-helvetica-light">
