    ...
    >
      <nav className="flex justify-between p-5 md:p-20 items-center">
        ...
        <div className="hidden md:block">
          <ul className="flex flex-row gap-4 md:gap-8 text-white items-center">
      ...
      <div className="font-bold text-4xl md:text-6xl text-yellow-500 uppercase mt-20 ml-10 md:mt-36 md:ml-40">
